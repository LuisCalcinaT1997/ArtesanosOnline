<?php 
check_user("productos.php") 
?>
<select id="categoria" onchange="redir_cat();" class="form-control"> <!-- Este select es corrcto-->
...
if(isset($cat)){
	$q= mysqli_query($obj_conexion, "SELECT * FROM productos WHERE id_categoria ='$cat' AND oferta>0 ORDER BY id DESC");
}else{
	$q= mysqli_query($obj_conexion, "SELECT * FROM productos WHERE oferta>0 ORDER BY id DESC");
}
