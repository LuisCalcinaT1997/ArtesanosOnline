...
if(isset($subir)){
	...
	mysqli_query($obj_conexion,"INSERT INTO pagos(id_cliente,comprobante,nombre,fecha) VALUES ('".$_SESSION['id_cliente']."','$comprobante','$nombre',NOW())");
...
<form method="post" action="" enctype="multipart/form-data">
	...
	<div class="form-group">
		<input type="text" class="form-control" name="nombre" title="Nombre de la personas que transfiere"/>
	</div>
	<div class="form-group">
