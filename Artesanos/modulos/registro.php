...
if(isset($enviar)){
	...
	$q = mysqli_query($obj_conexion,"SELECT * FROM clientes WHERE username = '$username'");
	...
	mysqli_query($obj_conexion,"INSERT INTO clientes (username,password,name) VALUES ('$username','$password','$nombre')");


	$q2 = mysqli_query($obj_conexion,"SELECT * FROM clientes WHERE username = '$username'");
